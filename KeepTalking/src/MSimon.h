...
const uint8_t PROGMEM pgm_simon[] = {
    ...
    // No vowel
    SIMON_YELLOW, SIMON_RED, SIMON_GREEN, SIMON_BLUE,
    SIMON_BLUE, SIMON_GREEN, SIMON_YELLOW, SIMON_RED,
    SIMON_GREEN, SIMON_RED, SIMON_BLUE, SIMON_YELLOW,
    // Vowel
    SIMON_RED, SIMON_GREEN, SIMON_YELLOW, SIMON_BLUE,
    SIMON_GREEN, SIMON_RED, SIMON_BLUE, SIMON_YELLOW,
